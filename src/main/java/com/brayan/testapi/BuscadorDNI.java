...
public class BuscadorDNI extends JFrame {
    ...
    private static final Dotenv dotenv = Dotenv.load(); // Cargar las variables del archivo .env
    private static final String TOKEN = dotenv.get("API_TOKEN"); // Obtener el token desde el archivo .env
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuscadorDNI frame = new BuscadorDNI();
	...
	public BuscadorDNI() {
		...
		JLabel lblNewLabel_NombreCompleto = new JLabel("");
		lblNewLabel_NombreCompleto.setBorder(new LineBorder(new Color(0, 0, 0)));
		lblNewLabel_NombreCompleto.setFont(new Font("Noto Serif", Font.PLAIN, 18));
		lblNewLabel_NombreCompleto.setBounds(28, 370, 484, 26);
		contentPane.add(lblNewLabel_NombreCompleto);
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblNewLabel_NombreCompleto.setText("");
			}
		});
                ...
                //    String response = makePostRequest(API_URL, TOKEN, dni);
                    ...
                    new SwingWorker<String, Void>() {
						...
						protected String doInBackground() throws Exception {
							...
							return  makePostRequest(API_URL, TOKEN, dni);
						}
						@Override
						protected void done() {
							try {
	                            ...
	                            if (jsonResponse.getBoolean("success")) {
	                                ...
	                                lblNewLabel_NombreCompleto.setText(nombreCompleto);
